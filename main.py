...
from handlers.products import products, view_product
from handlers.cart import cart, add_to_cart_handler, clear_cart_handler, checkout
...
from handlers.admin_products import (
    ...
    add_product_price, add_product_image, add_second_image_handler, add_second_image_input, 
    add_product_confirm, add_product_confirm_callback, view_products, delete_product_start, 
